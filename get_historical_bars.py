...
print("New York date and time: ", time_ny.strftime("%Y-%m-%d %H:%M:%S %Z"))

# Run only between allowed hours (4 AM - 8 PM EST)
# if time_ny.hour < 4 or time_ny.hour >= 20:
...
# filename = "/Users/jerzy/Develop/MachineTrader/Internship_Summer_2025/data/price_bars_" + date_today + ".csv"
...
for symbol in symbols:
    ...
    if price_bars[symbol]:
        ...
        # Save data frame to CSV
        filename = f"/Users/jerzy/Develop/MachineTrader/Internship_Summer_2025/data/price_bars_{symbol}_{date_today}.csv"
