### Liquidate all the open positions by submitting market orders, using the Alpaca SDK.
...
# Close all the positions and also cancel all the open orders
trading_client.close_all_positions(cancel_orders=True)


# Wait 10 seconds for positions to close
print("Waiting 10 seconds for positions to close...")
time.sleep(10)
...
if len(portfolio) == 0:
    ...
    print(f"There are still {len(portfolio)} open positions.")  
...
# Get all the prices for the symbols in the portfolio
# portfolio
symbol = "SPY"
