...
print(f"get_stock_latest_bar Open: {bar_data['open']}, High: {bar_data['high']}, Low: {bar_data['low']}, Close: {bar_data['close']}, Volume: {bar_data['volume']}, VWAP: {bar_data['vwap']}")
...
print(f"Endpoint latest Open: {bar_data['o']}, High: {bar_data['h']}, Low: {bar_data['l']}, Close: {bar_data['c']}, Volume: {bar_data['v']}, VWAP: {bar_data['vw']}")
...
time_ny = time_utc.astimezone(ZoneInfo("America/New_York"))
# time_utc = datetime.now(timezone.utc)
...
print(f"SDK Open: {bar_data['open']}, High: {bar_data['high']}, Low: {bar_data['low']}, Close: {bar_data['close']}, Volume: {bar_data['volume']}, VWAP: {bar_data['vwap']}")
